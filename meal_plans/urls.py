...
urlpatterns = [
    ...
    path('meal/<int:meal_id>/recipe/create/', views.recipe_create, name='recipe_create'),
    path('meal/<int:meal_id>/recipe/update/', views.recipe_update, name='recipe_update'),
    path('meal/<int:meal_id>/recipe/delete/', views.recipe_delete, name='recipe_delete'),
